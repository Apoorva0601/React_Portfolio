          ...
          >
            {courses.map((course) => (
              <SwiperSlide key={course.id}>
                ...
                >
                  {/* Course Image */}
                  <div className="relative overflow-hidden h-40 bg-gradient-to-br from-primary-400 to-primary-600">
                    <img
                      src={course.image}
                      alt={course.name}
                  ...
                  {/* Course Content */}
                  <div className="p-6">
                    <h3 className="text-lg font-bold text-gray-800 mb-2 group-hover:text-primary-600 transition-colors duration-200 line-clamp-2">
                      {course.name}
                    </h3>
